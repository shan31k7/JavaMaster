...
public class OverLoading {
	...
	// Overloaded methods will have same name
	// JVM uniquely identifies each overloaded method based on their arguments
	// arguments can differ in data-type/number of arguments/order of arguments
	...
	/*
	 * public String calculate(int data) // return type will not make any difference
	 * { return "Hello"; }
	 */
